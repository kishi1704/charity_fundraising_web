			...
			if (openFunds != null) {
				for (Fund f : openFunds) {
					out.println("<div class=\"open-fund col\">\r\n" + "	<div class=\"card h-100\">\r\n"
							+ "		<img src=\"" + f.getImage_url()
							+ "\" class=\"card-img-top\" alt=\"fund image\">\r\n"
							+ "		<div class=\"card-body\">\r\n"
							+ "			<h5 class=\"card-title fund-name pb-2\">" + f.getName() + "</h5>\r\n"
							+ "			<h6 class=\"card-subtitle text-muted  mb-2 pb-2\">\r\n" + "				<em>"
							+ f.getFoundation().getName() + "</em>\r\n" + "			</h6>\r\n"
							+ "			<p class=\"card-text mb-1\">" + f.getDescription() + "</p>\r\n"
							+ "			<a href=\"#\" class=\"stretched-link\"></a>\r\n" + "		</div>\r\n"
							+ "		<div class=\"card-footer bg-transparent border-top-0\">\r\n"
							+ "			<div class=\"d-flex justify-content-between\">\r\n" + "				<p>\r\n"
							+ "					<span class=\"font-weight-bold\">"
							+ vndFormat.format(f.getTotalDonation()) + "</span> /\r\n"
							+ "					<span class=\"text-secondary\">"
							+ vndFormat.format(f.getExpectedAmount()) + "</span>\r\n" + "				</p>"
							+ "				<p>\r\n"
							+ "					<span class=\"badge rounded-pill bg-success\">"
							+ df.format(f.getEndDate()) + "</span>\r\n" + "				</p>\r\n"
							+ "			</div>\r\n" + "			<div class=\"progress\" style=\"height: 5px\">\r\n"
							+ "				<div class=\"progress-bar bg-success\" role=\"progressbar\"\r\n"
							+ "					aria-valuenow=\"0\" aria-valuemin=\"0\" aria-valuemax=\"100\"\r\n"
							+ "					style=\"width:" + 100.0 * f.getTotalDonation() / f.getExpectedAmount()
							+ "%\"></div>\r\n" + "			</div>\r\n"
							+ "			<div class=\"d-flex justify-content-between align-items-center mt-3\">\r\n"
							+ displayBtn + "				<p class=\"mb-0 text-secondary\">\r\n"
							+ "					Đạt được <br> <span class=\"text-dark font-weight-bold\">"
							+ percentFormatter.format(f.getTotalDonation() * 1.0 / f.getExpectedAmount())
							+ "</span>\r\n" + "				</p>\r\n" + "			</div>\r\n" + "		</div>\r\n"
							+ "	</div>\r\n" + "</div>");
				}
			} else {
