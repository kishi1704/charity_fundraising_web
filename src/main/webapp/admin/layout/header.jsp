...
<aside class="sidebar text-white fs-5">
	<div class="list-group list-group-flush">
		<h3 class="text-center bg-dark py-3 mb-0 d-none d-md-inline">
			Trang quản trị</h3>
		<h5 class="py-3 ps-3 mb-0 d-none d-md-inline border-bottom border-dark">
			<i class="fa-solid fa-user"></i><span class="ms-2">${sessionScope.user.username}</span>
		</h5>
		<a href="${pageContext.request.contextPath}/admin" id="admin-home"
			class="list-group-item list-group-item-action py-3"> <i
			class="fa-solid fa-house"></i> <span class="ms-1 d-none d-md-inline">Trang
				chủ</span>
		</a><a href="${pageContext.request.contextPath}/admin?action=category"
			id="admin-category"
			class="list-group-item list-group-item-action py-3"> <i
			class="fa-solid fa-layer-group"></i> <span
			class="ms-1 d-none d-md-inline">Danh mục</span>
		</a><a href="${pageContext.request.contextPath}/admin?action=foundation" id="admin-foundation"
			class="list-group-item list-group-item-action py-3"> <i
			class="fa-solid fa-people-group"></i> <span
			class="ms-1 d-none d-md-inline">Nhà tổ chức</span>
		</a><a href="${pageContext.request.contextPath}/admin?action=fund" id="admin-fund"
			class="list-group-item list-group-item-action py-3"> <i
			class="fa-solid fa-sack-dollar"></i> <span
			class="ms-1 d-none d-md-inline">Quỹ quyên góp</span>
		</a><a href="${pageContext.request.contextPath}/admin?action=donation" id="admin-donation"
			class="list-group-item list-group-item-action py-3"><i
			class="fa-solid fa-hand-holding-heart"></i> <span
			class="ms-1 d-none d-md-inline">Lượt quyên góp</span> </a><a
			href="${pageContext.request.contextPath}/admin?action=user" id="admin-user"
			class="list-group-item list-group-item-action py-3"><i
